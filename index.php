...
<body>
    ...
    <div class="banner">
        ...
        <div class="content" id="home">
            <nav>
                <img src="./assets/files/prayana.png" class="logo" alt="Logo" title="Prayana">
                <ul class="navbar">
                    <li>
                        <a href="#home">Home</a>
...
<section>
            <div class="title">
                <h1>PRAYANA</h1>
                <p>Embark on a Journey of Discovery with Prayana!</p>
                <div class="wrapper">
                    <form action="#">
                        <div class="h5 font-weight-bold text-center mb-3">Search your Destination</div>
                        <div class="destination">
                            <label for="city">Enter the destination</label>
                        </div>
                        ...
                        <div class="form-group">
                            <input autocomplete="off" type="date" class="form-control" placeholder="Select your date" required>
                        </div>
                        <div class="form-group">
                            ...
                            <input id="mySlider" type="range" min="0" max="10000" value="2500" required>
                            <script>
    ...
    <section>
        ...
        <div class="pack4-content">
            <div style="text-align:center">
                <button type="button" class="btn btn-primary"><a href="./booking.php"><JavaBlink>Book Now</JavaBlink></a></button>
            </div>
        </div><br><br>
    </section>
    ...
    <section class="package2" id="package">
        ...
        <div class="package2-content">
            ...
            <a href="./assets/package.php#6000">
                <div class="box">
                    <div class="image">
        ...
        <div style="text-align:center">
            <button type="button" class="btn btn-primary"> <a href="package.php">Explore More</a></button>
        </div>
    </section><br><hr><br>
    ...
    <section class="locations" id="locations">
        ...
        <div class="location-content">
            ...
            <a href="./locations.php#port-blair">
                <div class="col-content">
    ...
    <section class="footer">
        ...
        <div class="end">
            <p>Copyright © 2023 Prayana All Rights Reserved.<br>Website developed by: Prayana </p>
        </div>
    </section>
